...
exports.UpdateRperHistoricalMappingService = void 0;
const tsyringe_1 = require("tsyringe");
const AppError_1 = __importDefault(require("../../../shared/errors/AppError"));
let UpdateRperHistoricalMappingService = class UpdateRperHistoricalMappingService {
    constructor(rperHistoricalMappingRepository, rpersRepository) {
    ...
    execute(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const historicalMapping = yield this.rperHistoricalMappingRepository.findByRperId(data.rper_id);
...
UpdateRperHistoricalMappingService = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('RperHistoricalMappingRepository')),
    __param(1, (0, tsyringe_1.inject)('RpersRepository')),
    __metadata("design:paramtypes", [Object, Object])
], UpdateRperHistoricalMappingService);
exports.UpdateRperHistoricalMappingService = UpdateRperHistoricalMappingService;
