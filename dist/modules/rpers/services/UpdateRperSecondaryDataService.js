...
exports.UpdateRperSecondaryDataService = void 0;
const tsyringe_1 = require("tsyringe");
const AppError_1 = __importDefault(require("../../../shared/errors/AppError"));
let UpdateRperSecondaryDataService = class UpdateRperSecondaryDataService {
    constructor(rpersSecondaryDataRepository, rpersRepository) {
    ...
    execute(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const secondaryData = yield this.rpersSecondaryDataRepository.findByRperId(data.rper_id);
...
UpdateRperSecondaryDataService = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('RpersSecondaryDataRepository')),
    __param(1, (0, tsyringe_1.inject)('RpersRepository')),
    __metadata("design:paramtypes", [Object, Object])
], UpdateRperSecondaryDataService);
exports.UpdateRperSecondaryDataService = UpdateRperSecondaryDataService;
