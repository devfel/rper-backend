...
exports.RemoveRperMemberService = void 0;
const tsyringe_1 = require("tsyringe");
const AppError_1 = __importDefault(require("../../../shared/errors/AppError"));
let RemoveRperMemberService = class RemoveRperMemberService {
    constructor(rpersRepository) {
        this.rpersRepository = rpersRepository;
    }
    execute({ rper_id, user_id }) {
...
RemoveRperMemberService = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)('RpersRepository')),
    __metadata("design:paramtypes", [Object])
], RemoveRperMemberService);
exports.RemoveRperMemberService = RemoveRperMemberService;
